...
export const portfolio: SisterSite[] = [
  { domain: "adversarialml.dev", url: "https://adversarialml.dev", title: "Adversarial ML", tagline: "Deploying language models that actually work." },
...
export const siteConfig: SiteConfig = {
  domain: "llmops.report",
  url: "https://llmops.report",
  title: "LLMOps Report",
  tagline: "Operating LLMs in production — eval, observability, cost, latency.",
  description:
  ...
  byline: "LLMOps Report Editorial",
  language: "en",
  locale: "en_US",
  themeColor: "#0a0a0a",
  brand: { accentHue: 158, cluster: "engineering" },
  social: { rss: "/rss.xml" },
  email: {
    contact: "hello@llmops.report",
    abuse: "abuse@llmops.report",
    editor: "editor@llmops.report",
  },
  ...
  sister: portfolio.filter((s) => s.domain !== "llmops.report"),
  analytics: {},
};
